// Refactored from Mersenne Twister implementation found in
...
export class Random {
  ...
  static hash(str: string, min: number = 0, max: number = 4294967295) {
    if (!str) {
      return min
    }
  ...
  public setSeed(seed: number | null = null) {
    if (seed == null) {
